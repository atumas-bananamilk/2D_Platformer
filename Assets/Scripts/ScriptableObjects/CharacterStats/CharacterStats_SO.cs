...
public class CharacterStats_SO : ScriptableObject
{
    ...
    // TODO EQUIPWEAPON AND EQUIP ARMOR
    public void EquipWeapon(ItemPickUp weaponPickUp, CharacterInventory charInventory, GameObject weaponSlot)
    {
         ...
         * newWeapon = Instantiate(weaponPickUp.itemDefinition.
         */
    }
    ...
    private void Death()
    {
        Debug.Log("You Died! Sorry!!");
        // Call to GameManager for Death State to trigger respawn
